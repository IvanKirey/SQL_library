...
namespace Курсовая
{
    public partial class UpdateExtradition : Form
    {
        public UpdateExtradition()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlText = "UPDATE dbo.[Выдача] SET Дата_возврата = ";
                SqlText = SqlText + "'" + textBox2.Text + "'";
                SqlText = SqlText + " WHERE dbo.Выдача.Код_выдачи = ";
